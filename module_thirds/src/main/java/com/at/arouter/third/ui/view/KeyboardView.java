...
//
//import com.atkj.chainplusclub.R;
//
...
//    }
//
//    public void setDismissListener(OnDismiss dismiss) {
...
//        LayoutInflater.from(context).inflate(R.layout.lay_key_board, this);
//        rlBack = findViewById(R.id.rl_back);
//        rlBack.setOnClickListener((view) -> { // 点击关闭键盘
//            if (dismiss != null) dismiss.onDismissClick();
//            dismiss();
//        });
...
//        animationIn = AnimationUtils.loadAnimation(getContext(), R.anim.dialog_enter);
//        animationOut = AnimationUtils.loadAnimation(getContext(), R.anim.dialog_exit);
//    }
//
//    // 弹出软键盘
//    public void show() {
