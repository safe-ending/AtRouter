...
public class ExpandableTextView extends LinearLayout {
        ...
        id_expand_textview.setOnClickListener((v) -> {
            ...
            animation.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation animation) {
                    clearAnimation();
                    isAnimate = false;
                    id_source_textview.setMaxLines(isCollapsed ? maxExpandLines : Integer.MAX_VALUE);
                    id_source_textview.setEllipsize(isCollapsed ? TextUtils.TruncateAt.END : null);
                }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        id_source_textview.setEllipsize(null);
        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
