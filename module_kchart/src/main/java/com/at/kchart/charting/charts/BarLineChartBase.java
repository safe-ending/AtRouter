...
package com.at.kchart.charting.charts;
...
import com.at.kchart.charting.highlight.ChartHighlighter;
import com.at.kchart.charting.highlight.Highlight;
import com.at.kchart.charting.interfaces.dataprovider.BarLineScatterCandleBubbleDataProvider;
import com.at.kchart.charting.interfaces.datasets.IBarLineScatterCandleBubbleDataSet;
import com.at.kchart.charting.jobs.AnimatedMoveViewJob;
import com.at.kchart.charting.jobs.AnimatedZoomJob;
import com.at.kchart.charting.jobs.MoveViewJob;
import com.at.kchart.charting.jobs.ZoomJob;
import com.at.kchart.charting.listener.BarLineChartTouchListener;
import com.at.kchart.charting.renderer.XAxisRenderer;
import com.at.kchart.charting.renderer.YAxisRenderer;
import com.at.kchart.charting.utils.MPPointD;
import com.at.kchart.charting.utils.Transformer;
import com.at.kchart.charting.utils.Utils;
import com.at.kchart.charting.listener.OnDrawListener;
...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
    ...
    protected void init() {
        ...
        mAxisLeft = new YAxis(YAxis.AxisDependency.RIGHT);
        mAxisRight = new YAxis(YAxis.AxisDependency.LEFT);
...
//        mRenderer.drawExtras(canvas);
    ...
    protected void autoScale() {
        ...
        if (mAxisRight.isEnabled()) {
            mAxisRight.calculate(mData.getYMin(YAxis.AxisDependency.LEFT),
    ...
    protected void calcMinMax() {
        ...
        // calculate axis range (min / max) according to provided data
        float y1 = mData.getYMin(YAxis.AxisDependency.RIGHT);

        mAxisLeft.calculate(mData.getYMin(YAxis.AxisDependency.RIGHT), mData.getYMax(YAxis.AxisDependency.RIGHT));
        mAxisRight.calculate(mData.getYMin(YAxis.AxisDependency.LEFT), mData.getYMax(YAxis.AxisDependency
                .LEFT));
    }
    ...
    public Transformer getTransformer(YAxis.AxisDependency which) {
        if (which == YAxis.AxisDependency.RIGHT) {
    ...
    public void moveViewToX(float xValue) {
        ...
        Runnable job = MoveViewJob.getInstance(mViewPortHandler, xValue, 0f,
                getTransformer(YAxis.AxisDependency.RIGHT), this);
...
//        });
    ...
    public float getLowestVisibleX() {
        getTransformer(YAxis.AxisDependency.RIGHT).getValuesByTouchPoint(mViewPortHandler.contentLeft(),
    ...
    public float getHighestVisibleX() {
        getTransformer(YAxis.AxisDependency.RIGHT).getValuesByTouchPoint(mViewPortHandler.contentRight(),
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mKeepPositionOnRotation) {
            ...
            getTransformer(YAxis.AxisDependency.RIGHT).pixelsToValue(mOnSizeChangedBuffer);
        }
        ...
        if (mKeepPositionOnRotation) {
            ...
            getTransformer(YAxis.AxisDependency.RIGHT).pointValuesToPixel(mOnSizeChangedBuffer);
