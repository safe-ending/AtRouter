...
import com.at.kchart.charting.highlight.BarHighlighter;
import com.at.kchart.charting.highlight.Highlight;
import com.at.kchart.charting.interfaces.dataprovider.BarDataProvider;
import com.at.kchart.charting.interfaces.datasets.IBarDataSet;
import com.at.kchart.charting.renderer.BarChartRenderer;
...
//        mRenderer = new BarChartRenderer(this, mAnimator, mViewPortHandler);
    ...
    protected void calcMinMax() {
        ...
        float l1 = mData.getYMin(YAxis.AxisDependency.RIGHT);
        float l2 = mData.getYMin(YAxis.AxisDependency.RIGHT);
        mAxisLeft.calculate(mData.getYMin(YAxis.AxisDependency.RIGHT), mData.getYMin(YAxis.AxisDependency.RIGHT));
        //右边区间
        float r1 = mData.getYMin(YAxis.AxisDependency.LEFT);
        float r2 = mData.getYMax(YAxis.AxisDependency.LEFT);
