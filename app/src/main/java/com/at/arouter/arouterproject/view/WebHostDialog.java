package com.at.arouter.arouterproject.view;
...
import com.at.arouter.arouterproject.MainActivity;
import com.at.arouter.arouterproject.R;
import com.at.arouter.common.data.APIHostManager;
import com.at.arouter.common.data.AppPref;
import com.at.arouter.user.LoginActivity;
    ...
    public void addContentItem(List<HostModel> list) {
        for (HostModel hostModel : list) {
            ...
            if (APIHostManager.Common_Url.equals(hostModel.host_one)
                    && APIHostManager.Trade_Url.equals(hostModel.host_two)
